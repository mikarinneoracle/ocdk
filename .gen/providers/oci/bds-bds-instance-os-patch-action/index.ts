// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action
...
export interface BdsBdsInstanceOsPatchActionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#bds_instance_id BdsBdsInstanceOsPatchAction#bds_instance_id}
  */
  readonly bdsInstanceId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#cluster_admin_password BdsBdsInstanceOsPatchAction#cluster_admin_password}
  */
  readonly clusterAdminPassword: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#id BdsBdsInstanceOsPatchAction#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#os_patch_version BdsBdsInstanceOsPatchAction#os_patch_version}
  */
  readonly osPatchVersion: string;
  /**
  * patching_configs block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#patching_configs BdsBdsInstanceOsPatchAction#patching_configs}
  */
  readonly patchingConfigs?: BdsBdsInstanceOsPatchActionPatchingConfigs[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#timeouts BdsBdsInstanceOsPatchAction#timeouts}
  */
  readonly timeouts?: BdsBdsInstanceOsPatchActionTimeouts;
}
export interface BdsBdsInstanceOsPatchActionPatchingConfigs {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#batch_size BdsBdsInstanceOsPatchAction#batch_size}
  */
  readonly batchSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#patching_config_strategy BdsBdsInstanceOsPatchAction#patching_config_strategy}
  */
  readonly patchingConfigStrategy: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#tolerance_threshold_per_batch BdsBdsInstanceOsPatchAction#tolerance_threshold_per_batch}
  */
  readonly toleranceThresholdPerBatch?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#wait_time_between_batch_in_seconds BdsBdsInstanceOsPatchAction#wait_time_between_batch_in_seconds}
  */
  readonly waitTimeBetweenBatchInSeconds?: number;
}

export function bdsBdsInstanceOsPatchActionPatchingConfigsToTerraform(struct?: BdsBdsInstanceOsPatchActionPatchingConfigs | cdktf.IResolvable): any {
...
export function bdsBdsInstanceOsPatchActionPatchingConfigsToHclTerraform(struct?: BdsBdsInstanceOsPatchActionPatchingConfigs | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class BdsBdsInstanceOsPatchActionPatchingConfigsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BdsBdsInstanceOsPatchActionPatchingConfigs | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: BdsBdsInstanceOsPatchActionPatchingConfigs | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class BdsBdsInstanceOsPatchActionPatchingConfigsList extends cdktf.ComplexList {
  public internalValue? : BdsBdsInstanceOsPatchActionPatchingConfigs[] | cdktf.IResolvable
  ...
  */
  public get(index: number): BdsBdsInstanceOsPatchActionPatchingConfigsOutputReference {
    return new BdsBdsInstanceOsPatchActionPatchingConfigsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface BdsBdsInstanceOsPatchActionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#create BdsBdsInstanceOsPatchAction#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#delete BdsBdsInstanceOsPatchAction#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#update BdsBdsInstanceOsPatchAction#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action oci_bds_bds_instance_os_patch_action}
*/
export class BdsBdsInstanceOsPatchAction extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BdsBdsInstanceOsPatchAction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/bds_bds_instance_os_patch_action oci_bds_bds_instance_os_patch_action} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _patchingConfigs = new BdsBdsInstanceOsPatchActionPatchingConfigsList(this, "patching_configs", false);
  public get patchingConfigs() {
    return this._patchingConfigs;
  }
  public putPatchingConfigs(value: BdsBdsInstanceOsPatchActionPatchingConfigs[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      patching_configs: cdktf.listMapper(bdsBdsInstanceOsPatchActionPatchingConfigsToTerraform, true)(this._patchingConfigs.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      patching_configs: {
        value: cdktf.listMapperHcl(bdsBdsInstanceOsPatchActionPatchingConfigsToHclTerraform, true)(this._patchingConfigs.internalValue),
        isBlock: true,
        type: "list",
