// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer
...
export interface BlockchainPeerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#ad BlockchainPeer#ad}
  */
  readonly ad: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#alias BlockchainPeer#alias}
  */
  readonly alias?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#blockchain_platform_id BlockchainPeer#blockchain_platform_id}
  */
  readonly blockchainPlatformId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#id BlockchainPeer#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#role BlockchainPeer#role}
  */
  readonly role: string;
  /**
  * ocpu_allocation_param block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#ocpu_allocation_param BlockchainPeer#ocpu_allocation_param}
  */
  readonly ocpuAllocationParam: BlockchainPeerOcpuAllocationParam;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#timeouts BlockchainPeer#timeouts}
  */
  readonly timeouts?: BlockchainPeerTimeouts;
}
export interface BlockchainPeerOcpuAllocationParam {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#ocpu_allocation_number BlockchainPeer#ocpu_allocation_number}
  */
...
export interface BlockchainPeerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#create BlockchainPeer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#delete BlockchainPeer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#update BlockchainPeer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer oci_blockchain_peer}
*/
export class BlockchainPeer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockchainPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/resources/blockchain_peer oci_blockchain_peer} Resource
  *
  * @param scope The scope in which to define this construct
