// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/ai_anomaly_detection_ai_private_endpoint
...
export interface DataOciAiAnomalyDetectionAiPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/ai_anomaly_detection_ai_private_endpoint#ai_private_endpoint_id DataOciAiAnomalyDetectionAiPrivateEndpoint#ai_private_endpoint_id}
  */
  readonly aiPrivateEndpointId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/ai_anomaly_detection_ai_private_endpoint oci_ai_anomaly_detection_ai_private_endpoint}
*/
export class DataOciAiAnomalyDetectionAiPrivateEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiAnomalyDetectionAiPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/ai_anomaly_detection_ai_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/ai_anomaly_detection_ai_private_endpoint oci_ai_anomaly_detection_ai_private_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
