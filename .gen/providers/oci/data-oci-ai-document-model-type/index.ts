// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type
...
export interface DataOciAiDocumentModelTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type#compartment_id DataOciAiDocumentModelType#compartment_id}
  */
  readonly compartmentId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type#id DataOciAiDocumentModelType#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type#model_sub_type DataOciAiDocumentModelType#model_sub_type}
  */
  readonly modelSubType?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type#model_type DataOciAiDocumentModelType#model_type}
  */
  readonly modelType: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type oci_ai_document_model_type}
*/
export class DataOciAiDocumentModelType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiDocumentModelType that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/ai_document_model_type oci_ai_document_model_type} Data Source
  *
  * @param scope The scope in which to define this construct
