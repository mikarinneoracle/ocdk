// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_context
...
export interface DataOciBatchBatchContextConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_context#batch_context_id DataOciBatchBatchContext#batch_context_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_context oci_batch_batch_context}
*/
export class DataOciBatchBatchContext extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBatchBatchContext that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_context#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_context oci_batch_batch_context} Data Source
  *
  * @param scope The scope in which to define this construct
