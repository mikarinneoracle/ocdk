// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_job_pool
...
export interface DataOciBatchBatchJobPoolConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_job_pool#batch_job_pool_id DataOciBatchBatchJobPool#batch_job_pool_id}
  */
  readonly batchJobPoolId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_job_pool oci_batch_batch_job_pool}
*/
export class DataOciBatchBatchJobPool extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBatchBatchJobPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_job_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_job_pool oci_batch_batch_job_pool} Data Source
  *
  * @param scope The scope in which to define this construct
