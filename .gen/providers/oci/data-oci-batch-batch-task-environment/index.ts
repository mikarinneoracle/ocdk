// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_environment
...
export interface DataOciBatchBatchTaskEnvironmentConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_environment#batch_task_environment_id DataOciBatchBatchTaskEnvironment#batch_task_environment_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_environment oci_batch_batch_task_environment}
*/
export class DataOciBatchBatchTaskEnvironment extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBatchBatchTaskEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_environment oci_batch_batch_task_environment} Data Source
  *
  * @param scope The scope in which to define this construct
