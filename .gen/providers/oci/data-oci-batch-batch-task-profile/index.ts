// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_profile
...
export interface DataOciBatchBatchTaskProfileConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_profile#batch_task_profile_id DataOciBatchBatchTaskProfile#batch_task_profile_id}
  */
  readonly batchTaskProfileId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_profile oci_batch_batch_task_profile}
*/
export class DataOciBatchBatchTaskProfile extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciBatchBatchTaskProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/batch_batch_task_profile oci_batch_batch_task_profile} Data Source
  *
  * @param scope The scope in which to define this construct
