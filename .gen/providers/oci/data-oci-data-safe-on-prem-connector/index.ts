// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_on_prem_connector
...
export interface DataOciDataSafeOnPremConnectorConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_on_prem_connector#on_prem_connector_id DataOciDataSafeOnPremConnector#on_prem_connector_id}
  */
  readonly onPremConnectorId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_on_prem_connector oci_data_safe_on_prem_connector}
*/
export class DataOciDataSafeOnPremConnector extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeOnPremConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_on_prem_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_on_prem_connector oci_data_safe_on_prem_connector} Data Source
  *
  * @param scope The scope in which to define this construct
