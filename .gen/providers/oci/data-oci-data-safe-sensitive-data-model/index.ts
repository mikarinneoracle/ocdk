// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_sensitive_data_model
...
export interface DataOciDataSafeSensitiveDataModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_sensitive_data_model#sensitive_data_model_id DataOciDataSafeSensitiveDataModel#sensitive_data_model_id}
  */
  readonly sensitiveDataModelId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_sensitive_data_model oci_data_safe_sensitive_data_model}
*/
export class DataOciDataSafeSensitiveDataModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataSafeSensitiveDataModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_sensitive_data_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/data_safe_sensitive_data_model oci_data_safe_sensitive_data_model} Data Source
  *
  * @param scope The scope in which to define this construct
