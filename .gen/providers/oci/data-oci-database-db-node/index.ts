// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_db_node
...
export interface DataOciDatabaseDbNodeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_db_node#db_node_id DataOciDatabaseDbNode#db_node_id}
  */
  readonly dbNodeId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_db_node oci_database_db_node}
*/
export class DataOciDatabaseDbNode extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseDbNode that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_db_node#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_db_node oci_database_db_node} Data Source
  *
  * @param scope The scope in which to define this construct
