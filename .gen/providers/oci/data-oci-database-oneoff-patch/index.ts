// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_oneoff_patch
...
export interface DataOciDatabaseOneoffPatchConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_oneoff_patch#oneoff_patch_id DataOciDatabaseOneoffPatch#oneoff_patch_id}
  */
  readonly oneoffPatchId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_oneoff_patch oci_database_oneoff_patch}
*/
export class DataOciDatabaseOneoffPatch extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseOneoffPatch that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_oneoff_patch#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/database_oneoff_patch oci_database_oneoff_patch} Data Source
  *
  * @param scope The scope in which to define this construct
