// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataflow_private_endpoint
...
export interface DataOciDataflowPrivateEndpointConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataflow_private_endpoint#private_endpoint_id DataOciDataflowPrivateEndpoint#private_endpoint_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataflow_private_endpoint oci_dataflow_private_endpoint}
*/
export class DataOciDataflowPrivateEndpoint extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataflowPrivateEndpoint that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataflow_private_endpoint#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataflow_private_endpoint oci_dataflow_private_endpoint} Data Source
  *
  * @param scope The scope in which to define this construct
