// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataintegration_workspace
...
export interface DataOciDataintegrationWorkspaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataintegration_workspace#workspace_id DataOciDataintegrationWorkspace#workspace_id}
  */
  readonly workspaceId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataintegration_workspace oci_dataintegration_workspace}
*/
export class DataOciDataintegrationWorkspace extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDataintegrationWorkspace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataintegration_workspace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dataintegration_workspace oci_dataintegration_workspace} Data Source
  *
  * @param scope The scope in which to define this construct
