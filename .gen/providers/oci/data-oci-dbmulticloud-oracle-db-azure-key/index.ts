// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key
...
export interface DataOciDbmulticloudOracleDbAzureKeyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key#id DataOciDbmulticloudOracleDbAzureKey#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key#oracle_db_azure_key_id DataOciDbmulticloudOracleDbAzureKey#oracle_db_azure_key_id}
  */
  readonly oracleDbAzureKeyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key oci_dbmulticloud_oracle_db_azure_key}
*/
export class DataOciDbmulticloudOracleDbAzureKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDbmulticloudOracleDbAzureKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/data-sources/dbmulticloud_oracle_db_azure_key oci_dbmulticloud_oracle_db_azure_key} Data Source
  *
  * @param scope The scope in which to define this construct
