// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view
...
export interface DataOciDnsViewConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view#scope DataOciDnsView#scope}
  */
  readonly scope?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view#view_id DataOciDnsView#view_id}
  */
  readonly viewId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view oci_dns_view}
*/
export class DataOciDnsView extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDnsView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/dns_view oci_dns_view} Data Source
  *
  * @param scope The scope in which to define this construct
