// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status
...
export interface DataOciFusionAppsFusionEnvironmentStatusConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status#fusion_environment_id DataOciFusionAppsFusionEnvironmentStatus#fusion_environment_id}
  */
  readonly fusionEnvironmentId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status#id DataOciFusionAppsFusionEnvironmentStatus#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status oci_fusion_apps_fusion_environment_status}
*/
export class DataOciFusionAppsFusionEnvironmentStatus extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciFusionAppsFusionEnvironmentStatus that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/fusion_apps_fusion_environment_status oci_fusion_apps_fusion_environment_status} Data Source
  *
  * @param scope The scope in which to define this construct
