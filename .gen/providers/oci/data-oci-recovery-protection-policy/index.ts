// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/recovery_protection_policy
...
export interface DataOciRecoveryProtectionPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/recovery_protection_policy#protection_policy_id DataOciRecoveryProtectionPolicy#protection_policy_id}
  */
  readonly protectionPolicyId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/recovery_protection_policy oci_recovery_protection_policy}
*/
export class DataOciRecoveryProtectionPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciRecoveryProtectionPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/recovery_protection_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/recovery_protection_policy oci_recovery_protection_policy} Data Source
  *
  * @param scope The scope in which to define this construct
