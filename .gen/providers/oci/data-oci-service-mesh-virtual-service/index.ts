// https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/service_mesh_virtual_service
...
export interface DataOciServiceMeshVirtualServiceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/service_mesh_virtual_service#virtual_service_id DataOciServiceMeshVirtualService#virtual_service_id}
  */
...
export function dataOciServiceMeshVirtualServiceDefaultRoutingPolicyToHclTerraform(struct?: DataOciServiceMeshVirtualServiceDefaultRoutingPolicy): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataOciServiceMeshVirtualServiceMtlsToHclTerraform(struct?: DataOciServiceMeshVirtualServiceMtls): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/service_mesh_virtual_service oci_service_mesh_virtual_service}
*/
export class DataOciServiceMeshVirtualService extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataOciServiceMeshVirtualService to import
  * @param importFromId The id of the existing DataOciServiceMeshVirtualService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/service_mesh_virtual_service#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataOciServiceMeshVirtualService to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/5.47.0/docs/data-sources/service_mesh_virtual_service oci_service_mesh_virtual_service} Data Source
  *
  * @param scope The scope in which to define this construct
