// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management
...
export interface DatabaseCloudExadataInfrastructureConfigureExascaleManagementConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#cloud_exadata_infrastructure_id DatabaseCloudExadataInfrastructureConfigureExascaleManagement#cloud_exadata_infrastructure_id}
  */
  readonly cloudExadataInfrastructureId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#id DatabaseCloudExadataInfrastructureConfigureExascaleManagement#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#total_storage_in_gbs DatabaseCloudExadataInfrastructureConfigureExascaleManagement#total_storage_in_gbs}
  */
  readonly totalStorageInGbs: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#total_vm_storage_in_gbs DatabaseCloudExadataInfrastructureConfigureExascaleManagement#total_vm_storage_in_gbs}
  */
  readonly totalVmStorageInGbs?: number;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#timeouts DatabaseCloudExadataInfrastructureConfigureExascaleManagement#timeouts}
  */
...
export class DatabaseCloudExadataInfrastructureConfigureExascaleManagementExascaleConfigOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // available_vm_storage_in_gbs - computed: true, optional: false, required: false
  public get availableVmStorageInGbs() {
    return this.getNumberAttribute('available_vm_storage_in_gbs');
  }
  ...
  // total_vm_storage_in_gbs - computed: true, optional: false, required: false
  public get totalVmStorageInGbs() {
    return this.getNumberAttribute('total_vm_storage_in_gbs');
  }
}
...
export interface DatabaseCloudExadataInfrastructureConfigureExascaleManagementTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#create DatabaseCloudExadataInfrastructureConfigureExascaleManagement#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#delete DatabaseCloudExadataInfrastructureConfigureExascaleManagement#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#update DatabaseCloudExadataInfrastructureConfigureExascaleManagement#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management oci_database_cloud_exadata_infrastructure_configure_exascale_management}
*/
export class DatabaseCloudExadataInfrastructureConfigureExascaleManagement extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseCloudExadataInfrastructureConfigureExascaleManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/database_cloud_exadata_infrastructure_configure_exascale_management oci_database_cloud_exadata_infrastructure_configure_exascale_management} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: DatabaseCloudExadataInfrastructureConfigureExascaleManagementConfig) {
    ...
    this._totalVmStorageInGbs = config.totalVmStorageInGbs;
  ...
  // total_vm_storage_in_gbs - computed: true, optional: true, required: false
  private _totalVmStorageInGbs?: number; 
  public get totalVmStorageInGbs() {
    return this.getNumberAttribute('total_vm_storage_in_gbs');
  }
  public set totalVmStorageInGbs(value: number) {
    this._totalVmStorageInGbs = value;
  }
  public resetTotalVmStorageInGbs() {
    this._totalVmStorageInGbs = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get totalVmStorageInGbsInput() {
    return this._totalVmStorageInGbs;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      total_vm_storage_in_gbs: cdktf.numberToTerraform(this._totalVmStorageInGbs),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      total_vm_storage_in_gbs: {
        value: cdktf.numberToHclTerraform(this._totalVmStorageInGbs),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
