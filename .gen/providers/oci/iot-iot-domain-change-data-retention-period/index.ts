// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period
...
export interface IotIotDomainChangeDataRetentionPeriodConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#data_retention_period_in_days IotIotDomainChangeDataRetentionPeriod#data_retention_period_in_days}
  */
  readonly dataRetentionPeriodInDays: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#id IotIotDomainChangeDataRetentionPeriod#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#iot_domain_id IotIotDomainChangeDataRetentionPeriod#iot_domain_id}
  */
  readonly iotDomainId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#type IotIotDomainChangeDataRetentionPeriod#type}
  */
  readonly type: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#timeouts IotIotDomainChangeDataRetentionPeriod#timeouts}
  */
...
export interface IotIotDomainChangeDataRetentionPeriodTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#create IotIotDomainChangeDataRetentionPeriod#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#delete IotIotDomainChangeDataRetentionPeriod#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#update IotIotDomainChangeDataRetentionPeriod#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period oci_iot_iot_domain_change_data_retention_period}
*/
export class IotIotDomainChangeDataRetentionPeriod extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotIotDomainChangeDataRetentionPeriod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/iot_iot_domain_change_data_retention_period oci_iot_iot_domain_change_data_retention_period} Resource
  *
  * @param scope The scope in which to define this construct
