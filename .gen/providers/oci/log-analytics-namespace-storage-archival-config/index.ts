// https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config
...
export interface LogAnalyticsNamespaceStorageArchivalConfigConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#id LogAnalyticsNamespaceStorageArchivalConfig#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#namespace LogAnalyticsNamespaceStorageArchivalConfig#namespace}
  */
  readonly namespace: string;
  /**
  * archiving_configuration block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#archiving_configuration LogAnalyticsNamespaceStorageArchivalConfig#archiving_configuration}
  */
  readonly archivingConfiguration: LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#timeouts LogAnalyticsNamespaceStorageArchivalConfig#timeouts}
  */
...
export interface LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#active_storage_duration LogAnalyticsNamespaceStorageArchivalConfig#active_storage_duration}
  */
  readonly activeStorageDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#archival_storage_duration LogAnalyticsNamespaceStorageArchivalConfig#archival_storage_duration}
  */
  readonly archivalStorageDuration?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#time_oldest_active_bucket_ended LogAnalyticsNamespaceStorageArchivalConfig#time_oldest_active_bucket_ended}
  */
  readonly timeOldestActiveBucketEnded?: string;
}
...
export function logAnalyticsNamespaceStorageArchivalConfigArchivingConfigurationToTerraform(struct?: LogAnalyticsNamespaceStorageArchivalConfigArchivingConfigurationOutputReference | LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration): any {
  ...
  return {
    ...
    time_oldest_active_bucket_ended: cdktf.stringToTerraform(struct!.timeOldestActiveBucketEnded),
  }
}
...
export function logAnalyticsNamespaceStorageArchivalConfigArchivingConfigurationToHclTerraform(struct?: LogAnalyticsNamespaceStorageArchivalConfigArchivingConfigurationOutputReference | LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration): any {
  ...
  const attrs = {
    ...
    time_oldest_active_bucket_ended: {
      value: cdktf.stringToHclTerraform(struct!.timeOldestActiveBucketEnded),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class LogAnalyticsNamespaceStorageArchivalConfigArchivingConfigurationOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration | undefined {
    ...
    if (this._timeOldestActiveBucketEnded !== undefined) {
      hasAnyValues = true;
      internalValueResult.timeOldestActiveBucketEnded = this._timeOldestActiveBucketEnded;
    }
  ...
  public set internalValue(value: LogAnalyticsNamespaceStorageArchivalConfigArchivingConfiguration | undefined) {
    if (value === undefined) {
      ...
      this._timeOldestActiveBucketEnded = undefined;
    }
    else {
      ...
      this._timeOldestActiveBucketEnded = value.timeOldestActiveBucketEnded;
    }
  }
  ...
  // time_oldest_active_bucket_ended - computed: true, optional: true, required: false
  private _timeOldestActiveBucketEnded?: string; 
  public get timeOldestActiveBucketEnded() {
    return this.getStringAttribute('time_oldest_active_bucket_ended');
  }
  public set timeOldestActiveBucketEnded(value: string) {
    this._timeOldestActiveBucketEnded = value;
  }
  public resetTimeOldestActiveBucketEnded() {
    this._timeOldestActiveBucketEnded = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get timeOldestActiveBucketEndedInput() {
    return this._timeOldestActiveBucketEnded;
  }
}
export interface LogAnalyticsNamespaceStorageArchivalConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#create LogAnalyticsNamespaceStorageArchivalConfig#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#delete LogAnalyticsNamespaceStorageArchivalConfig#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#update LogAnalyticsNamespaceStorageArchivalConfig#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config}
*/
export class LogAnalyticsNamespaceStorageArchivalConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing LogAnalyticsNamespaceStorageArchivalConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/oci/8.2.0/docs/resources/log_analytics_namespace_storage_archival_config oci_log_analytics_namespace_storage_archival_config} Resource
  *
  * @param scope The scope in which to define this construct
