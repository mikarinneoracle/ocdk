// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_api
...
export interface DataOciApigatewayApiConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_api#api_id DataOciApigatewayApi#api_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_api oci_apigateway_api}
*/
export class DataOciApigatewayApi extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApigatewayApi that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_api#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_api oci_apigateway_api} Data Source
  *
  * @param scope The scope in which to define this construct
