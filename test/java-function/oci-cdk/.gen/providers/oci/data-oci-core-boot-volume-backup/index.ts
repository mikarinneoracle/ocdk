// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_boot_volume_backup
...
export interface DataOciCoreBootVolumeBackupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_boot_volume_backup#boot_volume_backup_id DataOciCoreBootVolumeBackup#boot_volume_backup_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_boot_volume_backup oci_core_boot_volume_backup}
*/
export class DataOciCoreBootVolumeBackup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreBootVolumeBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_boot_volume_backup#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_boot_volume_backup oci_core_boot_volume_backup} Data Source
  *
  * @param scope The scope in which to define this construct
