// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_drg_route_distribution
...
export interface DataOciCoreDrgRouteDistributionConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_drg_route_distribution#drg_route_distribution_id DataOciCoreDrgRouteDistribution#drg_route_distribution_id}
  */
  readonly drgRouteDistributionId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_drg_route_distribution oci_core_drg_route_distribution}
*/
export class DataOciCoreDrgRouteDistribution extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreDrgRouteDistribution that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_drg_route_distribution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_drg_route_distribution oci_core_drg_route_distribution} Data Source
  *
  * @param scope The scope in which to define this construct
