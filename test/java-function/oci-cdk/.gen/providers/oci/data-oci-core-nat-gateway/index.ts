// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_nat_gateway
...
export interface DataOciCoreNatGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_nat_gateway#nat_gateway_id DataOciCoreNatGateway#nat_gateway_id}
  */
  readonly natGatewayId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_nat_gateway oci_core_nat_gateway}
*/
export class DataOciCoreNatGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreNatGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_nat_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_nat_gateway oci_core_nat_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
