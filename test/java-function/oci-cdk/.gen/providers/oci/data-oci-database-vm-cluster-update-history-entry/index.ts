// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry
...
export interface DataOciDatabaseVmClusterUpdateHistoryEntryConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry#id DataOciDatabaseVmClusterUpdateHistoryEntry#id}
  *
  ...
  */
  readonly id?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry#update_history_entry_id DataOciDatabaseVmClusterUpdateHistoryEntry#update_history_entry_id}
  */
  readonly updateHistoryEntryId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry#vm_cluster_id DataOciDatabaseVmClusterUpdateHistoryEntry#vm_cluster_id}
  */
  readonly vmClusterId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry oci_database_vm_cluster_update_history_entry}
*/
export class DataOciDatabaseVmClusterUpdateHistoryEntry extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDatabaseVmClusterUpdateHistoryEntry that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/database_vm_cluster_update_history_entry oci_database_vm_cluster_update_history_entry} Data Source
  *
  * @param scope The scope in which to define this construct
