// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_sender
...
export interface DataOciEmailSenderConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_sender#sender_id DataOciEmailSender#sender_id}
  */
  readonly senderId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_sender oci_email_sender}
*/
export class DataOciEmailSender extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEmailSender that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_sender#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_sender oci_email_sender} Data Source
  *
  * @param scope The scope in which to define this construct
