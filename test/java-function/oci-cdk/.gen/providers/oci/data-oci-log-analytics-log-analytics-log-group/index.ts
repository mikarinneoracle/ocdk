// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group
...
export interface DataOciLogAnalyticsLogAnalyticsLogGroupConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group#log_analytics_log_group_id DataOciLogAnalyticsLogAnalyticsLogGroup#log_analytics_log_group_id}
  */
  readonly logAnalyticsLogGroupId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group#namespace DataOciLogAnalyticsLogAnalyticsLogGroup#namespace}
  */
  readonly namespace: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group oci_log_analytics_log_analytics_log_group}
*/
export class DataOciLogAnalyticsLogAnalyticsLogGroup extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciLogAnalyticsLogAnalyticsLogGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/log_analytics_log_analytics_log_group oci_log_analytics_log_analytics_log_group} Data Source
  *
  * @param scope The scope in which to define this construct
