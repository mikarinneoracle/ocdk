// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ocvp_cluster
...
export interface DataOciOcvpClusterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ocvp_cluster#cluster_id DataOciOcvpCluster#cluster_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ocvp_cluster oci_ocvp_cluster}
*/
export class DataOciOcvpCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOcvpCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ocvp_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ocvp_cluster oci_ocvp_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
