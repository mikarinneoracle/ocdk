// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ai_anomaly_detection_model
...
export interface DataOciAiAnomalyDetectionModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ai_anomaly_detection_model#model_id DataOciAiAnomalyDetectionModel#model_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ai_anomaly_detection_model oci_ai_anomaly_detection_model}
*/
export class DataOciAiAnomalyDetectionModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciAiAnomalyDetectionModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ai_anomaly_detection_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/ai_anomaly_detection_model oci_ai_anomaly_detection_model} Data Source
  *
  * @param scope The scope in which to define this construct
