// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_gateway
...
export interface DataOciApigatewayGatewayConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_gateway#gateway_id DataOciApigatewayGateway#gateway_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_gateway oci_apigateway_gateway}
*/
export class DataOciApigatewayGateway extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciApigatewayGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_gateway#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/apigateway_gateway oci_apigateway_gateway} Data Source
  *
  * @param scope The scope in which to define this construct
