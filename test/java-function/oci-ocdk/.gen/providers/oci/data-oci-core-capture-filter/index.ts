// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_capture_filter
...
export interface DataOciCoreCaptureFilterConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_capture_filter#capture_filter_id DataOciCoreCaptureFilter#capture_filter_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_capture_filter oci_core_capture_filter}
*/
export class DataOciCoreCaptureFilter extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreCaptureFilter that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_capture_filter#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_capture_filter oci_core_capture_filter} Data Source
  *
  * @param scope The scope in which to define this construct
