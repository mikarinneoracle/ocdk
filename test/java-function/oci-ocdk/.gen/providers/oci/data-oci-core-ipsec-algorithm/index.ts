// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_ipsec_algorithm
...
export interface DataOciCoreIpsecAlgorithmConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_ipsec_algorithm#id DataOciCoreIpsecAlgorithm#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_ipsec_algorithm oci_core_ipsec_algorithm}
*/
export class DataOciCoreIpsecAlgorithm extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreIpsecAlgorithm that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_ipsec_algorithm#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_ipsec_algorithm oci_core_ipsec_algorithm} Data Source
  *
  * @param scope The scope in which to define this construct
