// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_private_ip
...
export interface DataOciCorePrivateIpConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_private_ip#private_ip_id DataOciCorePrivateIp#private_ip_id}
  */
  readonly privateIpId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_private_ip oci_core_private_ip}
*/
export class DataOciCorePrivateIp extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCorePrivateIp that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_private_ip#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_private_ip oci_core_private_ip} Data Source
  *
  * @param scope The scope in which to define this construct
