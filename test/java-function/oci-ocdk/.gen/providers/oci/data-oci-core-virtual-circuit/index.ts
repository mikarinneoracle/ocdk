// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_virtual_circuit
...
export interface DataOciCoreVirtualCircuitConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_virtual_circuit#virtual_circuit_id DataOciCoreVirtualCircuit#virtual_circuit_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_virtual_circuit oci_core_virtual_circuit}
*/
export class DataOciCoreVirtualCircuit extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciCoreVirtualCircuit that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_virtual_circuit#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/core_virtual_circuit oci_core_virtual_circuit} Data Source
  *
  * @param scope The scope in which to define this construct
