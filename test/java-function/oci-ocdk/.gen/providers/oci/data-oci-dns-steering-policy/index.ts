// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/dns_steering_policy
...
export interface DataOciDnsSteeringPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/dns_steering_policy#steering_policy_id DataOciDnsSteeringPolicy#steering_policy_id}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/dns_steering_policy oci_dns_steering_policy}
*/
export class DataOciDnsSteeringPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciDnsSteeringPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/dns_steering_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/dns_steering_policy oci_dns_steering_policy} Data Source
  *
  * @param scope The scope in which to define this construct
