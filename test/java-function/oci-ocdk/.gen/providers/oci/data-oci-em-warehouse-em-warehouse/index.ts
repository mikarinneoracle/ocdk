// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/em_warehouse_em_warehouse
...
export interface DataOciEmWarehouseEmWarehouseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/em_warehouse_em_warehouse#em_warehouse_id DataOciEmWarehouseEmWarehouse#em_warehouse_id}
  */
  readonly emWarehouseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/em_warehouse_em_warehouse oci_em_warehouse_em_warehouse}
*/
export class DataOciEmWarehouseEmWarehouse extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEmWarehouseEmWarehouse that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/em_warehouse_em_warehouse#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/em_warehouse_em_warehouse oci_em_warehouse_em_warehouse} Data Source
  *
  * @param scope The scope in which to define this construct
