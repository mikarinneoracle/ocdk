// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_email_domain
...
export interface DataOciEmailEmailDomainConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_email_domain#email_domain_id DataOciEmailEmailDomain#email_domain_id}
  */
  readonly emailDomainId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_email_domain oci_email_email_domain}
*/
export class DataOciEmailEmailDomain extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciEmailEmailDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_email_domain#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/email_email_domain oci_email_email_domain} Data Source
  *
  * @param scope The scope in which to define this construct
