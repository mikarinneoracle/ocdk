// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family
...
export interface DataOciJmsJavaFamilyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family#family_version DataOciJmsJavaFamily#family_version}
  */
  readonly familyVersion: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family#id DataOciJmsJavaFamily#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family oci_jms_java_family}
*/
export class DataOciJmsJavaFamily extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciJmsJavaFamily that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/jms_java_family oci_jms_java_family} Data Source
  *
  * @param scope The scope in which to define this construct
