// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/opsi_operations_insights_warehouse
...
export interface DataOciOpsiOperationsInsightsWarehouseConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/opsi_operations_insights_warehouse#operations_insights_warehouse_id DataOciOpsiOperationsInsightsWarehouse#operations_insights_warehouse_id}
  */
  readonly operationsInsightsWarehouseId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/opsi_operations_insights_warehouse oci_opsi_operations_insights_warehouse}
*/
export class DataOciOpsiOperationsInsightsWarehouse extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciOpsiOperationsInsightsWarehouse that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/opsi_operations_insights_warehouse#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/opsi_operations_insights_warehouse oci_opsi_operations_insights_warehouse} Data Source
  *
  * @param scope The scope in which to define this construct
