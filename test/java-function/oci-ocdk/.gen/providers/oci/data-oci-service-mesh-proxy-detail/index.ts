// https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/service_mesh_proxy_detail
...
export interface DataOciServiceMeshProxyDetailConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/service_mesh_proxy_detail#id DataOciServiceMeshProxyDetail#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/service_mesh_proxy_detail oci_service_mesh_proxy_detail}
*/
export class DataOciServiceMeshProxyDetail extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataOciServiceMeshProxyDetail that should be imported. Refer to the {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/service_mesh_proxy_detail#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/oracle/oci/5.47.0/docs/data-sources/service_mesh_proxy_detail oci_service_mesh_proxy_detail} Data Source
  *
  * @param scope The scope in which to define this construct
