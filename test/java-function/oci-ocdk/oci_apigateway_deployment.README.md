...
- **CLI-only workflow:** If you create the gateway and function outside Terraform, you can create the deployment with:
  ...
  - `oci api-gateway deployment create --compartment-id $compartment_ocid --gateway-id $gateway_ocid --path-prefix "/test" --specification file://./oci_apigateway_deployment.json`
